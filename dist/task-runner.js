...
taskrunner.XHRTask.prototype.onXhrRequestSuccess = function() {
  this.state_ === taskrunner.TaskState.RUNNING && this.completeInternal(this.xhrRequest_.getResponseText() || this.xhrRequest_.getResponseXml());
};
taskrunner.XHRTask.prototype.onXhrRequestErrorOrTimeout = function() {
  this.state_ === taskrunner.TaskState.RUNNING && this.errorInternal(this.xhrRequest_.getLastErrorCode(), this.xhrRequest_.getLastError());
};
